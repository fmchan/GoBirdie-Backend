...
class TagApiTest extends TestCase
{
    ...
    public function test_create_tag()
    {
        ...
        $this->response = $this->json('POST', '/api/tags', $tag);
    ...
    {
        $tag = $this->makeTag();
        $this->response = $this->json('GET', '/api/tags/'.$tag->id);
    ...
    public function test_update_tag()
    {
        ...
        $this->response = $this->json('PUT', '/api/tags/'.$tag->id, $editedTag);
    ...
    {
        $tag = $this->makeTag();
        $this->response = $this->json('DELETE', '/api/tags/'.$tag->id);
