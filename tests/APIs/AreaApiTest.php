...
class AreaApiTest extends TestCase
{
    ...
    public function test_create_area()
    {
        ...
        $this->response = $this->json('POST', '/api/areas', $area);
    ...
    {
        $area = $this->makeArea();
        $this->response = $this->json('GET', '/api/areas/'.$area->id);
    ...
    public function test_update_area()
    {
        ...
        $this->response = $this->json('PUT', '/api/areas/'.$area->id, $editedArea);
    ...
    {
        $area = $this->makeArea();
        $this->response = $this->json('DELETE', '/api/areas/'.$area->id);
